...
export const NotFound = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            const goDark = () => {
                ...
                gsap.set(["#lettersShadow1", "#lettersShadow2"], { opacity: 0.05 });
            ...
            const goLight = () => {
                ...
                gsap.set(["#lettersShadow1", "#lettersShadow2"], { opacity: 0.2 });
    ...
    return (
        <div className="notfound-container" ref={yetiRef}>
            <div className="notfound-wrapper">
                ...
                <g id="fingersBackL" style={{ visibility: 'hidden' }} fill="#88C9F2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5">
                ...
                <g id="fingersBackR" style={{ visibility: 'hidden' }} fill="#88c9f2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5">
                ...
                <g id="fingersFrontL" style={{ visibility: 'hidden' }}>
                    <path fill="#88C9F2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M146.2 165.1l2.8 11.6c.6 2.7 3.3 4.3 6 3.7 2.7-.6 4.3-3.3 3.7-6l-1.6-6.8c-.6-2.7-3.3-4.3-6-3.7l-4.9 1.2" />
                    <path fill="#A9DDF3" d="M151.4 173.8l.5 2.2c.3 1.1 1.3 1.7 2.4 1.5 1.1-.3 1.7-1.3 1.5-2.4l-.5-2.2-3.9.9z" />
                    <path fill="#88C9F2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M136.5 167.4l2.8 11.6c.6 2.7 3.3 4.3 6 3.7 2.7-.6 4.3-3.3 3.7-6l-2.8-11.6-9.7 2.3z" />
                    <path fill="#A9DDF3" d="M141.7 176.2l.5 2.2c.3 1.1 1.3 1.7 2.4 1.5 1.1-.3 1.7-1.3 1.5-2.4l-.5-2.2-3.9.9z" />
                    <path fill="#88C9F2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M127.9 174.6l1.6 6.8c.6 2.7 3.3 4.3 6 3.7 2.7-.6 4.3-3.3 3.7-6l-2.8-11.6-4.9 1.2c-2.6.5-4.2 3.2-3.6 5.9z" />
                ...
                <g id="fingersFrontR" style={{ visibility: 'hidden' }}>
                    <path fill="#88c9f2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M207.1 142.5l7.9 8.9c1.8 2.1 5 2.3 7.1.4 2.1-1.8 2.3-5 .4-7.1l-4.6-5.2c-1.8-2.1-5-2.2-7-.4l-3.8 3.4" />
                    <path fill="#A9DDF3" d="M215.8 147.7l1.5 1.7c.7.8 2 .9 2.8.2.8-.7.9-2 .2-2.8l-1.5-1.7-3 2.6z" />
                    <path fill="#88c9f2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M199.6 149.1l7.9 8.9c1.8 2.1 5 2.3 7.1.4 2.1-1.8 2.3-5 .4-7.1l-7.9-8.9-7.5 6.7z" />
                    <path fill="#A9DDF3" d="M208.3 154.4l1.5 1.7c.7.8 2 .9 2.8.2.8-.7.9-2 .2-2.8l-1.5-1.7-3 2.6z" />
                    <path fill="#88c9f2" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" d="M195.4 159.5l4.6 5.2c1.8 2.1 5 2.3 7.1.4 2.1-1.8 2.3-5 .4-7.1l-7.9-8.9-3.7 3.3c-2.1 1.9-2.3 5-.5 7.1z" />
